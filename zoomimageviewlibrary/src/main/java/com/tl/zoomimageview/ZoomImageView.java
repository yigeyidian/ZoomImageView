...
public class ZoomImageView extends ImageView implements IZoomImageView {
    ...
    protected void init() {
        if (null == mAttacher || null == mAttacher.getImageView()) {
            mAttacher = new ZoomImageViewAttacher(this);
        }
    ...
    @Override
    public void setOnMatrixChangeListener(ZoomImageViewAttacher.OnMatrixChangedListener listener) {
    ...
    @Override
    public void setOnPhotoTapListener(ZoomImageViewAttacher.OnPhotoTapListener listener) {
    ...
    @Override
    public void setOnViewTapListener(ZoomImageViewAttacher.OnViewTapListener listener) {
